...
class cdp_cookies
{
	...
	static function renderizar_aviso()
	{
		...
		//
		$boton = '';	
                $boton = '<a href="javascript:;" class="cdp-cookies-boton-aviso">' . do_shortcode(self::parametro( 'comportamiento' )) . '</a>';
	...
	static function ajax_crear_paginas()
	{
         ...
         * @return string
         */
        static function construirStringFooter($mapa_web, $aviso_legal, $politica_cookies, $politica_privacidad, $escape=true){
            ...
            $contenido_footer   =   '© ' . $nombre_web . ' - ' .
                                    ...
                                    '<a href="http://www.3comunicacion.com/" target="_blank">Desarrollado por 3com</a>';             
            if ($escape){
	...
	{		
		...
		{	
			...
			self::parametro( 'tam_fuente', cdp_cookies_input::post( 'tam_fuente' ) );
                        ...
                        $contenido_footer   =   self::construirStringFooter($mapa_web, $aviso_legal, $politica_cookies, $politica_privacidad, false);                              
		...
		$vdef =
			...
			(
				...
				'enlace_mapa_web'			=>  '#',
				                ...
				                'persona_autorizada'            =>  '#',
				                'telefono'                      =>  '#',
				'texto_aviso' 				=>  htmlspecialchars( '<h4 {estilo_titulo}>Uso de cookies</h4><p {estilo_texto}>Este sitio web utiliza cookies para que usted tenga la mejor experiencia de usuario. <a href="{enlace_politica}" {estilo_enlace}>Más información</a>.</p>' ),
				'tam_fuente' 				=>  '12px'
			);
